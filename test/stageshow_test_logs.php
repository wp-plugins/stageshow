...
include STAGESHOW_INCLUDE_PATH.'stageshowlib_gateway_callback.php';

if (!class_exists('StageShow_Test_logs')) 
{
	class StageShow_Test_logs extends StageShowLibTestBaseClass // Define class
	{
