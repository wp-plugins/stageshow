...
StageShowLib_DTPicker.prototype.RenderCssCal = function (bNewCal)
{
    ...
    if (this.ShowTime === true)
    {
        ...
        vCalTime += "<input class='button-secondary calButton' onClick='javascript: " + this.CalObjName + ".closewin(\"" + this.Ctrl + "\");' type=\"button\" value=\"OK\">&nbsp;";
        vCalTime += "<input class='button-secondary calButton' onClick='javascript: " + this.CalObjName + ".winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
    }
...
function StageShowLib_DateTimeSelect(pSender, pFormat, pShowTime, pShowSeconds, pEnableDateMode, pTimeDropdownIncrements)
{
    ...
    if (!StageShowCal)
    {
        StageShowCal = new StageShowLib_DTPicker(dtToday);
    }

	var pickerObj = StageShowCal;
...
function StageShowLib_CalendarSelector(pSender, pMode)
{
	...
	return StageShowLib_DateTimeSelect(pSender, pFormat, pShowTime, pShowSeconds, pEnableDateMode, pTimeDropdownIncrements);
}
