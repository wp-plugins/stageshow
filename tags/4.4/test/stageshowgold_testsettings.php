...
include STAGESHOW_TEST_PATH.'stageshowplus_testsettings.php';  

if (!class_exists('StageShowGoldTestSettingsAdminClass')) 
{
	class StageShowGoldTestSettingsAdminClass extends StageShowPlusTestSettingsAdminClass // Define class
	{
