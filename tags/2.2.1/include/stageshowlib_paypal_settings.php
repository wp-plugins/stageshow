	...
	{	
		...
		function GetDetailsRowsDefinition()
		{
			...
			$rowDefs = array(
				...
				array(self::TABLEPARAM_LABEL => 'Merchant ID',                     self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'PayPalMerchantID',      self::TABLEPARAM_TYPE => self::TABLEENTRY_TEXT,   self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_LEN => PAYPAL_APILIB_PPLOGIN_MERCHANTID_TEXTLEN,  self::TABLEPARAM_SIZE => PAYPAL_APILIB_PPLOGIN_EDITLEN, ),
				array(self::TABLEPARAM_LABEL => 'API User',                        self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'PayPalAPIUser',         self::TABLEPARAM_TYPE => self::TABLEENTRY_TEXT,   self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_LEN => PAYPAL_APILIB_PPLOGIN_USER_TEXTLEN,        self::TABLEPARAM_SIZE => PAYPAL_APILIB_PPLOGIN_EDITLEN, ),
				array(self::TABLEPARAM_LABEL => 'API Password',                    self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'PayPalAPIPwd',          self::TABLEPARAM_TYPE => self::TABLEENTRY_TEXT,   self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_LEN => PAYPAL_APILIB_PPLOGIN_PWD_TEXTLEN,         self::TABLEPARAM_SIZE => PAYPAL_APILIB_PPLOGIN_EDITLEN, ),
				array(self::TABLEPARAM_LABEL => 'API Signature',                   self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'PayPalAPISig',          self::TABLEPARAM_TYPE => self::TABLEENTRY_TEXT,   self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_LEN => PAYPAL_APILIB_PPLOGIN_SIG_TEXTLEN,         self::TABLEPARAM_SIZE => PAYPAL_APILIB_PPLOGIN_EDITLEN,  ),
				array(self::TABLEPARAM_LABEL => 'Account EMail',                   self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'PayPalAPIEMail',        self::TABLEPARAM_TYPE => self::TABLEENTRY_TEXT,   self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_LEN => PAYPAL_APILIB_PPLOGIN_EMAIL_TEXTLEN,       self::TABLEPARAM_SIZE => PAYPAL_APILIB_PPLOGIN_EDITLEN, ),
				array(self::TABLEPARAM_LABEL => 'Checkout Timeout',                self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'CheckoutTimeout',       self::TABLEPARAM_TYPE => self::TABLEENTRY_TEXT,   self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_LEN => PAYPAL_APILIB_CHECKOUT_TIMEOUT_TEXTLEN,    self::TABLEPARAM_SIZE => PAYPAL_APILIB_CHECKOUT_TIMEOUT_EDITLEN, ),
				array(self::TABLEPARAM_LABEL => 'Currency',                        self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'PayPalCurrency',        self::TABLEPARAM_TYPE => self::TABLEENTRY_SELECT, self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_ITEMS => $currSelect, ),
				...
				array(self::TABLEPARAM_LABEL => 'Checkout Complete URL',           self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'CheckoutCompleteURL',   self::TABLEPARAM_TYPE => self::TABLEENTRY_TEXT,   self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_LEN => PAYPAL_APILIB_URL_TEXTLEN,         self::TABLEPARAM_SIZE => PAYPAL_APILIB_URL_EDITLEN,  ),
				array(self::TABLEPARAM_LABEL => 'Checkout Cancelled URL',          self::TABLEPARAM_TAB => 'paypal-settings-tab', self::TABLEPARAM_ID => 'CheckoutCancelledURL',  self::TABLEPARAM_TYPE => self::TABLEENTRY_TEXT,   self::TABLEPARAM_PAYPALEDIT => true, self::TABLEPARAM_LEN => PAYPAL_APILIB_URL_TEXTLEN,         self::TABLEPARAM_SIZE => PAYPAL_APILIB_URL_EDITLEN,  ),
			);
