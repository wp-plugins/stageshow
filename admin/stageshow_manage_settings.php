	...
	{		
		...
		function GetDetailsRowsDefinition()
		{
			...
			$rowDefs = array(
				...
				array(StageShowLibTableClass::TABLEPARAM_LABEL => 'Add Ticket Quantities',           StageShowLibTableClass::TABLEPARAM_TAB => 'advanced-settings-tab',  StageShowLibTableClass::TABLEPARAM_ID => 'QtySelectTextInput',    StageShowLibTableClass::TABLEPARAM_TYPE => self::TABLEENTRY_CHECKBOX, StageShowLibTableClass::TABLEPARAM_TEXT => 'Enter Ticket Quantities as Text',  StageShowLibTableClass::TABLEPARAM_DEFAULT => false ),
			);
